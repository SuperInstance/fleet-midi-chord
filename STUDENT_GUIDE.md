# Student Guide: fleet-midi-chord

_Learn how the chord agent works and how to use it._

---

## What You'll Learn

1. What the chord musical concept is
2. How ternary decomposition applies to chord
...
```bash
curl -s http://localhost:2160/health | python3 -m json.tool
```
